...
export default function Contact({ settings }) {
  const whatsappNumber = (settings?.whatsappNumber || "917005310568").replace(/\D/g, "");
  ...
  return (
    <>
      ...
      <section className="contact-section" id="contact" style={{ paddingBottom: '30px' }}>
        <div className="max-w">
          <div className="contact-header-original reveal" style={{ display: 'flex', alignItems: 'center', gap: '40px', flexWrap: 'nowrap', justifyContent: 'flex-start' }}>
            ...
            <div className="cho-static-timings reveal" style={{ borderLeft: "1px solid rgba(255,255,255,0.1)", paddingLeft: "20px", marginTop: "15px" }}>
              <div className="sh-label" style={{ marginBottom: "6px", fontSize: "16px", letterSpacing: "2px" }}>TIMINGS</div>
              <div className="cho-timings-list" style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                <div className="cho-time-group" style={{ gap: "8px" }}>
                  <span className="cho-season" style={{ minWidth: "55px", fontSize: "11px" }}>MON - SAT</span>
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <span className="sh-red" style={{ fontSize: "14px" }}>5:00 AM - 10:00 AM</span>
                    <span className="sh-red" style={{ fontSize: "14px" }}>3:00 PM -  9:00 PM</span>
                  </div>
                </div>
                <div className="cho-time-group" style={{ gap: "8px" }}>
                  <span className="cho-season" style={{ minWidth: "55px", fontSize: "11px" }}>SUNDAY</span>
                  <span className="sh-red" style={{ fontSize: "14px" }}>3:00 PM - 9:00 PM</span>
                </div>
              </div>
            </div>
          ...
          <div className="contact-social-strip reveal">
            <a href={settings?.instagramUrl || "https://www.instagram.com/nme_gym"} className="cs-item" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
                <circle cx="12" cy="12" r="4" />
                <circle cx="17.5" cy="6.5" r="0.6" fill="currentColor" stroke="none" />
              </svg>
              <span>{settings?.instagramUrl?.split('/').pop() || "@nme_gym"}</span>
            </a>
            <div className="cs-sep"></div>
            <a href={`mailto:${settings?.email || "nmegym.india@gmail.com"}`} className="cs-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <polyline points="2,4 12,13 22,4" />
              </svg>
              <span>{settings?.email?.split('@')[0] || "nmegym.india"}</span>
            </a>
            <div className="cs-sep"></div>
            <a href={`https://wa.me/${whatsappNumber}`} className="cs-item" target="_blank" rel="noopener noreferrer">
              ...
              <span>{settings?.whatsappNumber || "+91 70053 10568"}</span>
            </a>
          </div>

          <div className="immersive-map reveal">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3590.5354400310657!2d93.75548789999999!3d25.8518491!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x374609311d747ce9%3A0x83acd9f8a16e1ed5!2sKemnbay%20Hostel!5e0!3m2!1sen!2sin!4v1778862081767!5m2!1sen!2sin"
              allowFullScreen
              loading="lazy"
            ></iframe>
          ...
          <div className="footer-links-row" style={{ marginTop: "32px" }}>
            ...
            <div className="footer-col">
              ...
              <a href={`mailto:${settings?.email || "nmegym.india@gmail.com"}`}>Email Us</a>
              <Link href="/legal">Legal Policy</Link>
            </div>
            <div className="footer-col">
              <h5>Follow</h5>
              <a href={settings?.instagramUrl || "https://www.instagram.com/nme_gym?igsh=MWwzeXJ5aDVwa3o1aA=="} target="_blank" rel="noopener noreferrer">Instagram</a>
              <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer">WhatsApp</a>
      ...
      <a
        href={`https://wa.me/${whatsappNumber}?text=Hi%20NME%20Gym!%20I%20need%20some%20assistance.`}
        className="wa-float"
        target="_blank"
